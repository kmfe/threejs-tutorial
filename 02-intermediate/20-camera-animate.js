...
function main () {
  ...
  * */
  ...
  // 尝试一些操作试试
  let p1 = {x:0,y:10,z:20};
  let tweena = cameraCon({x:20,y:2,z:0},9000);
  let tweenb = cameraCon({x:0,y:10,z:-20},9000);
  let tweenc = cameraCon({x:-20,y:2,z:0},4000);
  let tweend = cameraCon({x:0,y:10,z:20},4000);
  
  function cameraCon(p2={x:10,y:30,z:10},time=6000) {
    let tween1 = new TWEEN.Tween(p1)
    .to(p2,time)
